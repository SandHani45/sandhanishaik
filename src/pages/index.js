...
export default function Home() {
  return (
    <>
      <Head>
        <title>Sandhani Shaik Portfolio in Nextjs</title>
        <meta
          name="description"
          content="Next Portfolio, A open-source portfolio build in sandhani shaik"
        />
      </Head>
        ...
        <Layout className="!pt-24 md:!pt-16 sm:!pt-28">
          <div className="flex w-full items-start justify-between md:flex-col pt-10 pb-24">
            ...
            <div className="flex w-1/2 flex-col items-center self-center lg:w-full lg:text-center">
              ...
              Experienced Full Stack Developer with a strong foundation in the MERN (MongoDB, Express.js, React.js, Node.js) stack. Adept at designing, developing, and deploying scalable web and mobile applications. Passionate about creating seamless user experiences and efficient backend solutions. Proficient in modern JavaScript frameworks, API integration, and database management. Known for problem-solving skills, attention to detail, and a commitment to delivering high-quality, on-time results.
              </p>
