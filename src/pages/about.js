...
export default function About() {
  return (
    <>
      <Head>
        <title>About Sandhani Shaik</title>
        <meta
          name="description"
          content="Sandhani Shaik, About Sandhani Shaik and working skills "
        />
      </Head>
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            ...
            >
              ...
              <p className="font-medium ">
                I'm Sandhani Shaik, a dedicated web developer at LG Soft india,
              ...
              <p className="my-4 font-medium">
                At LG, I've had the opportunity to work on
